...
c.add_property(name = "G0_iw",
               getter = cfunction("block_gf_view<triqs::mesh::imfreq, triqs::gfs::scalar_valued> G0_iw ()"),
               doc = r"""Access non-interacting Matsubara Green function""")

c.add_property(name = "G0_tau",
               getter = cfunction("block_gf_view<triqs::mesh::imtime, triqs::gfs::scalar_valued> G0_tau ()"),
               doc = r"""Access non-interacting imaginary-time Green function""")

c.add_property(name = "G_iw",
               getter = cfunction("block_gf_view<triqs::mesh::imfreq, triqs::gfs::scalar_valued> G_iw ()"),
